...
- `docs/methods/event-modeling.md` — Event Model as a lens; slices, GWT, grouping hierarchy
- `docs/methods/paths.md` — PATHs: named actor journeys, example data, registry, chaining, runtime PATHs
- `docs/methods/fnhci.md` — FnHCI targets and lens pipeline
- `docs/architecture/components.md` — full component map including PAXUS
- `docs/principles/nexus.md` — the 7 NEXUS principles
